...
const BSTvisual
 = () => {
  ...
  const inorderRec = (node) => {
    ...
    setNodes((prevNodes) => [
      ...
      <div
        ...
        className="p-1 h-10 w-10 bg-blue-500 rounded-full flex items-center justify-center "
        key={node.key}
      >
        {node.key}
      </div>,
      ...
      setEdges((prevEdges) => [
        ...
        <div
          style={{
            ...
            transform: `rotate(${
              Math.atan2(node.left.y - node.y, node.left.x - node.x) + 0.8+depth
            }rad)`,
          }}
          className=" h-[6px] bg-green-500"
      ...
      setEdges((prevEdges) => [
        ...
        <div
          style={{
            ...
            transform: `rotate(${
              Math.atan2(node.right.y - node.y, node.right.x - node.x) - 0.55+depth
            }rad)`,
          }}
          className="h-[6px] bg-black"
  ...
  return (
    <div className="h-auto w-[100%] bg-blue-200 relative flex flex-col">
      <h1>Binary Search Tree BSTvisual
